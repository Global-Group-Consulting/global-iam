window.addEventListener("DOMContentLoaded", function () {
  ...
  const resetCronUserPasswordModal = document.getElementById("resetCronUserPassword");
  ...
  if (resetCronUserPasswordModal) {
    resetCronUserPasswordModal.addEventListener('show.bs.modal', function (event) {
      // Button that triggered the modal
      const button = event.relatedTarget
